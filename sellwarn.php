...
<div class="mywarnings" style="background-color: #F8F8F8;width: 20em;height: 16.8em;margin-top: 2.2em;border-radius: 20px;box-shadow: 10px 10px grey;position:fixed;top:10%;left: 5%;right:0%;">
	<h4><strong>Please Note</strong> <span class="blinking"><i class="fas fa-exclamation-circle"></i></span></i>
</h4>
		<h5> 
			<ul>
				<li style="color:red;font-weight: bolder;text-shadow: 0.3px 0.3px black;">Image-file Should be in .png .jpg or .jpeg ONLY.</li><br>
